...
SWIFT_MODULE_NAMESPACE_PUSH("MjpegStreamingKit")
@class UIImageView;
@class UIImage;
@class NSURLSession;
...
SWIFT_CLASS("_TtC17MjpegStreamingKit24MjpegStreamingController")
@interface MjpegStreamingController : NSObject <NSURLSessionDataDelegate>
@property (nonatomic, copy) void (^ _Nullable didStartLoading)(void);
@property (nonatomic, copy) void (^ _Nullable didFinishLoading)(void);
@property (nonatomic, copy) NSURL * _Nullable contentURL;
@property (nonatomic, strong) UIImageView * _Nonnull imageView;
@property (nonatomic, strong) UIImage * _Nullable currentFrame;
- (nonnull instancetype)initWithImageView:(UIImageView * _Nonnull)imageView OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithImageView:(UIImageView * _Nonnull)imageView contentURL:(NSURL * _Nonnull)contentURL;
